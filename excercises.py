...
class Ui_MainWindow_Exercises:  # (object)
    def setupUi(self, MainWindow):
        ...
        self.label_title.setGeometry(QtCore.QRect(340, -20, 321, 81))
        font = QtGui.QFont()
        ...
        self.label_exerciseName.setGeometry(QtCore.QRect(10, 50, 471, 101))
        font = QtGui.QFont()
        ...
        self.graphicsView_videoRecorded = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView_videoRecorded.setGeometry(QtCore.QRect(500, 50, 480, 360))
        self.graphicsView_videoRecorded.setObjectName("graphicsView_videoRecorded")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "Welcom to LymphCoach"))
