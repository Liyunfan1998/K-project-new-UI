...
from Tools.Utils import MyCalendar
...
class Ui_MainWindow_Home:  # (QMainWindow)
    def setupUi(self, MainWindow):
        ...
        self.label_title.setGeometry(QtCore.QRect(260, -10, 331, 81))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "Welcome to LymphCoach"))
